...
class BamLocation(ObjectType):
    ...
    bam_house = PropertyTypeAssignment(
        ...
        description="BAM House//BAM Geb�ude/Haus",
        mandatory=False,
        show_in_edit_views=False,
        section="GENERAL LOCATION",
    )
...
class TestObject(ObjectType):
    ...
    rectangle_length = PropertyTypeAssignment(
        ...
        description="Rectangle length [m]//L�nge des Rechtecks [m]",
        mandatory=False,
        show_in_edit_views=False,
        section="TEST_PROPERTIES",
    )
    ...
    rectangle_area = PropertyTypeAssignment(
        ...
        description="Rectangle area [m�]//Fl�che des Rechtecks [m�]",
        mandatory=False,
        show_in_edit_views=False,
        section="TEST_PROPERTIES",
    )
...
class Task(ObjectType):
    ...
    last_check = PropertyTypeAssignment(
        ...
        description="Date of the last check//Datum der letzten �berpr�fung",
        mandatory=True,
        show_in_edit_views=False,
        section="Automation",
    )
    ...
    freq_check = PropertyTypeAssignment(
        ...
        description="Time required to check in Days//�berpr�fungsintervall in Tagen",
        mandatory=True,
        show_in_edit_views=False,
        section="Automation",
    )
    ...
    state_check = PropertyTypeAssignment(
        ...
        description="TRUE if onject needs to be checked//WAHR wenn das Objekt �berpr�ft werden muss",
        mandatory=True,
        show_in_edit_views=False,
        section="Automation",
    )
...
class Chemical(ObjectType):
    ...
    alias = PropertyTypeAssignment(
        ...
        description="e.g. abbreviation or nickname//z.B. Abk�rzung oder Spitzname//z.B. Abk�rzung oder Spitzname",
        mandatory=False,
        show_in_edit_views=False,
        section="General Information",
    )
    ...
    date_bottling = PropertyTypeAssignment(
        ...
        description="Date of Bottling//Abf�lldatum",
        mandatory=False,
        show_in_edit_views=False,
        section="Handling",
    )
    ...
    date_opening = PropertyTypeAssignment(
        ...
        description="Opening Data//�ffnungsdatum",
        mandatory=False,
        show_in_edit_views=False,
        section="Handling",
    )
