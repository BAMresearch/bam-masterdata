...
class CreepTestMetadataMeasuringAndTestEquipmentTemperatureMeasuringSystemTemperatureSensor(ObjectType):
    defs = ObjectTypeDef(
...
class CreepTestMetadataMeasuringAndTestEquipmentTemperatureMeasuringSystemDataAcquisition(ObjectType):
    defs = ObjectTypeDef(
...
class CreepTestMetadataMeasuringAndTestEquipmentExtensionValuesContactingExtensometer(ObjectType):
    defs = ObjectTypeDef(
...
class CreepTestMetadataMeasuringAndTestEquipmentElongationValuesAndCrossSectionalDimensions(ObjectType):
    defs = ObjectTypeDef(
