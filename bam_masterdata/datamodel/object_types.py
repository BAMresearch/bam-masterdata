...
class LaserMagnet(Weldment):
    ...
    workpiece_thickness = PropertyTypeAssignment(
        ...
        description="""Workpiece thickness [mm]//Probendicke [mm]""",
        mandatory=False,
        show_in_edit_views=True,
        section="Workpiece",
    )
    ...
    workpiece_surface_preparation = PropertyTypeAssignment(
        ...
        description="""Surface preparation of the workpiece//Oberflächenbearbeitung der Probe""",
        mandatory=False,
        show_in_edit_views=True,
        section="Workpiece",
    )
    ...
    shielding_gas_flowrate = PropertyTypeAssignment(
        ...
        data_type="REAL",
        property_label="Shielding gas flowrate [l/min]",
        description="""Shielding gas flowrate//Schutzgasflussrate""",
        mandatory=False,
        show_in_edit_views=True,
        section="Welding Parameters",
    )
